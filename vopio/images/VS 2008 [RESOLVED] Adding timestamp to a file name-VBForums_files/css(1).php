...
.postbitlegacy .postfoot .textcontrols a.google, .postbit .postfoot .textcontrols a.google  {
	padding: 0px 10px 16px 10px;
}
.postbitlegacy .postfoot .textcontrols a.facebook, .postbit .postfoot .textcontrols a.facebook  {
	padding: 0px 10px 16px 10px;
}
.postbitlegacy .postfoot .textcontrols a.linkedin, .postbit .postfoot .textcontrols a.linkedin  {
	padding: 0px 10px 16px 10px;
}
.postbitlegacy .postfoot .textcontrols a.twitter, .postbit .postfoot .textcontrols a.twitter  {
	padding: 0px 10px 16px 10px;
}
