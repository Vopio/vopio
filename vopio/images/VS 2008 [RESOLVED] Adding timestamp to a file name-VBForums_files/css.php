...
.above_body {
	background:#0D5692 none repeat-x  ;
	_background-image: none;
...
.toplinks ul.isuser, .toplinks ul.nouser {
	...
	float: right;
	clear: left;
	list-style: none;background-color:#F1F1F1
...
.toplinks ul.isuser .notifications .popupbody {
	background: #738FBF;
	border: 1px solid #738FBF; /* makes it look consistent with the popup background */
}
...
.toplinks ul.isuser .notifications .popupbody li a{
	...
	border-top:1px solid #738FBF; /* makes it look consistent with the popup background */
	/*position: relative;*/
	text-align: left;
	padding-left: 30px;
	line-height: 26px;
...
.navtabs {
	background:#738FBF none repeat-x  ;
...
.toplinks .notifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl.active , .toplinks .notifications a.popupctrl.active{
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #738FBF url(/images/misc/arrow.png) no-repeat right center;
        _background-image:url('/images/misc/arrow.gif');
}
